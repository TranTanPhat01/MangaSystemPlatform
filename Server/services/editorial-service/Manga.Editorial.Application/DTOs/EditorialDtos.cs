...
public sealed class RankingItemResponse { public Guid SeriesId { get; set; } public int VoteCount { get; set; } public int RankPosition { get; set; } public int? PreviousRank { get; set; } public decimal PositiveRate { get; set; } public string Trend { get; set; } = "New"; public string RiskLevel { get; set; } = "Low"; public decimal Score { get; set; } }
