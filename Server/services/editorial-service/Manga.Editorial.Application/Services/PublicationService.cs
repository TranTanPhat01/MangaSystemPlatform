...
{
    private readonly IEditorialRepository _repository; private readonly IEditorialUnitOfWork _unitOfWork; private readonly ICurrentUserService _currentUser; private readonly IMangaLookupClient _manga;
    public PublicationService(IEditorialRepository repository, IEditorialUnitOfWork unitOfWork, ICurrentUserService currentUser, IMangaLookupClient manga) { _repository = repository; _unitOfWork = unitOfWork; _currentUser = currentUser; _manga = manga; }
