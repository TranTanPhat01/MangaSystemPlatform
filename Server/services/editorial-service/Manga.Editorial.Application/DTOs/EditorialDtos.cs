...
public sealed class EditorialReviewResponse { public Guid Id { get; set; } public Guid ChapterId { get; set; } public Guid SeriesId { get; set; } public Guid RequestedByUserId { get; set; } public Guid? ReviewerUserId { get; set; } public EditorialReviewStatus Status { get; set; } public string? DecisionNote { get; set; } public DateTime CreatedAt { get; set; } public DateTime? UpdatedAt { get; set; } public EditorialCommentResponse? LatestComment { get; set; } public List<EditorialReviewHistoryResponse> History { get; set; } = new(); }
public sealed class EditorialReviewHistoryResponse { public Guid Id { get; set; } public EditorialReviewStatus Status { get; set; } public string? DecisionNote { get; set; } public DateTime CreatedAt { get; set; } public DateTime? UpdatedAt { get; set; } public List<EditorialCommentResponse> Comments { get; set; } = new(); }
...
public sealed class BoardVoteSummaryResponse { public Guid SeriesId { get; set; } public int Approve { get; set; } public int Reject { get; set; } public int Revision { get; set; } public int Abstain { get; set; } public int Total { get; set; } public bool QuorumReached { get; set; } public string FinalRecommendation { get; set; } = "Pending"; }
public sealed class FinalizeProposalRequest { public bool AdminOverride { get; set; } public string? Reason { get; set; } }
...
public sealed class ReaderVoteRequest { public Guid SeriesId { get; set; } [Range(0, int.MaxValue)] public int VoteCount { get; set; } public Guid? ReaderId { get; set; } }
public sealed class ReaderVoteResponse { public Guid Id { get; set; } public Guid IssueId { get; set; } public Guid SeriesId { get; set; } public Guid ReaderId { get; set; } public int VoteCount { get; set; } public int? RankPosition { get; set; } public Guid ImportedByUserId { get; set; } public DateTime CreatedAt { get; set; } }
public sealed class RankingItemResponse { public Guid SeriesId { get; set; } public int VoteCount { get; set; } public int RankPosition { get; set; } public int? PreviousRank { get; set; } public decimal PositiveRate { get; set; } public string Trend { get; set; } = "New"; public string RiskLevel { get; set; } = "Low"; public decimal Score { get; set; } public DateTime? SnapshotGeneratedAt { get; set; } }
