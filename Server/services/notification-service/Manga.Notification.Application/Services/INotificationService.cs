...
{
    Task<IReadOnlyList<NotificationResponse>> GetMineAsync(bool? isRead, int page, int pageSize, CancellationToken cancellationToken = default);
    ...
    Task<NotificationResponse> MarkAsUnreadAsync(Guid notificationId, CancellationToken cancellationToken = default);
